use vid_kit_simple_lib::gpu_detector::{GpuInfo, GpuList, check_gpu_availability, check_ffmpeg_codec};
...
fn test_mock_gpu_list() {
    ...
    assert_eq!(mock_gpu_list.gpus.len(), 2, "Mock GPU list should have 2 items");
